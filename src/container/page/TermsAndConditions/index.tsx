...
const TermsAndConditions = () => {
  ...
  return (
    <style.Wrapper>
      ...
      <div className="flex flex-col gap-6 container mx-auto my-16">
        <section className="flex flex-col gap-4">
          ...
          <p>
            You can contact us by phone at +91-99884-70143, email at
            contact@thefalcon.dev, or by mail to Chandigarh, Chandigarh, Punjab
            160017, India.
          </p>
          <p>
          ...
          <p>
            ...
            effective upon posting or notifying you by noreply@thefalcon.dev ,
        ...
        <section className="flex flex-col gap-4">
          ...
          <ol className="list-decimal pl-10 text-blue-600">
            <li>
              <a href="#d">OUR SERVICES</a>
            </li>
            <li>
              <a href="#d">INTELLECTUAL PROPERTY RIGHTS</a>
            </li>
            <li>
              <a href="#d">USER REPRESENTATIONS</a>
            </li>
            <li>
              <a href="#d">PROHIBITED ACTIVITIES</a>
            </li>
            <li>
              <a href="#d">USER GENERATED CONTRIBUTIONS</a>
            </li>
            <li>
              <a href="#d">CONTRIBUTION LICENCE</a>
            </li>
            <li>
              <a href="#d">THIRD-PARTY WEBSITES AND CONTENT</a>
            </li>
            <li>
              <a href="#d">ADVERTISERS</a>
            </li>
            <li>
              <a href="#d">SERVICES MANAGEMENT</a>
            </li>
            <li>
              <a href="#d">PRIVACY POLICY</a>
            </li>
            <li>
              <a href="#d">TERM AND TERMINATION</a>
            </li>
            <li>
              <a href="#d">MODIFICATIONS AND INTERRUPTIONS</a>
            </li>
            <li>
              <a href="#d">GOVERNING LAW</a>
            </li>
            <li>
              <a href="#d">DISPUTE RESOLUTION</a>
            </li>
            <li>
              <a href="#d">CORRECTIONS</a>
            </li>
            <li>
              <a href="#d">DISCLAIMER</a>
            </li>
            <li>
              <a href="#d">LIMITATIONS OF LIABILITY</a>
            </li>
            <li>
              <a href="#d">INDEMNIFICATION</a>
            </li>
            <li>
              <a href="#d">USER DATA</a>
            </li>
            <li>
              <a href="#d">
            ...
            <li>
              <a href="#d">CALIFORNIA USERS AND RESIDENTS</a>
            </li>
            <li>
              <a href="#d">MISCELLANEOUS</a>
            </li>
            <li>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">1. OUR SERVICES</h2>
          <p>
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            please address your request to: contact@thefalcon.dev. If we ever
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">3. USER REPRESENTATIONS</h2>
        ...
        <section className="flex flex-col gap-4" id="prohibited-activities">
          <h2 className="font-bold text-2xl">4. PROHIBITED ACTIVITIES</h2>
          ...
          <ul className="list-disc pl-4">
            ...
            <li>Using information at other platform.</li>
          </ul>
        </section>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">6. CONTRIBUTION LICENCE</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">8. ADVERTISERS</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">9. SERVICES MANAGEMENT</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">10. PRIVACY POLICY</h2>

          <p>
            We care about data privacy and security. Please review our Privacy
            Policy:{' '}
            <a href="/legal/privacy-policy/" target="_blank">
              https://www.thefalcon.dev/legal/privacy-policy/
            </a>
            . By using the Services, you agree to be bound by our Privacy
            Policy, which is incorporated into these Legal Terms. Please be
            advised the Services are hosted in the United Kingdom. If you access
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">11. TERM AND TERMINATION</h2>
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            laws of India. The Falcon and yourself irrevocably consent that the
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">14. DISPUTE RESOLUTION</h2>
          ...
          <p>
            ...
            arbitration shall be Chandigarh, India. The language of the
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">15. CORRECTIONS</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">16. DISCLAIMER</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">17. LIMITATIONS OF LIABILITY</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">18. INDEMNIFICATION</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">19. USER DATA</h2>
        ...
        <section className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">22. MISCELLANEOUS</h2>
        ...
        <section id="contact-us" className="flex flex-col gap-4">
          <h2 className="font-bold text-2xl">23. CONTACT US</h2>
          ...
          <ul className="list-none font-bold">
            <li>The Falcon</li>
            <li>Chandigarh</li>
            <li>Chandigarh, Punjab 160017</li>
            <li>India</li>
            <li>Phone: +91-99884-70143</li>
            <li>contact@thefalcon.dev</li>
          </ul>
        </section>
      </div>
    </style.Wrapper>
